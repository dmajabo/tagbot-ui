  ...
  <div id="root">
    <header class="header-section">
      <div class="content flex-header">
        <div class="left-header"><a class="logotype" href="#">
        ...
        <div class="right-header"><a class="aws-acc" href="#">{{ $t('nav.aws_accounts') }}</a>
          <a class="users" href="#">{{ $t('nav.users') }}</a>
          <a class="set-acc line-acc mobile" href="#">{{ $t('nav.account_settings') }}</a>
          <span class="set-acc mobile" @click.prevent="logout()">{{ $t('common.logout') }}</span>
          <span class="header-line"></span>
          <div class="user-info"><span class="username">{{ user.name }}</span>
            ...
            <div class="hover-menu">
              ...
              <span @click.prevent="logout()">{{ $t('common.logout') }}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <main>
      <section class="main-section">
        <div class="content flex-main">
          <div style="display: flex; min-height: 300px; width: 100%; justify-content: center; align-items: center;">
            <span style="font-size: 3em; color: rgb(255, 255, 255); font-weight: bold;">404 | Page not found.</span>
          </div>
        </div>
      </section>
    </main>
