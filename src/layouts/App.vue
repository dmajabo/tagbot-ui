        ...
        <div class="left-menu">
          <div class="upper-menu"><a class="logotype" href="#" @click.prevent="$goTo('dashboard')">
            ...
            <nav class="main-navigation">
              <a :class="getNavClass(item.route)" href="#" v-for="item in nav" @click.prevent="$goTo(item.route)">{{ $t('nav.' + item.name) }}</a>
            </nav>
          </div>
          <div class="lower-info">
            ...
            <div class="settings-block space-left">
              <a :class="getUserNavClass(item.route)" v-for="item in userNav" href="#" @click.prevent="$goTo(item.route)">{{ $t('nav.' + item.name) }}</a>
            </div>
...
export default {
  ...
  created() {
    // uncomment line below if tou want to log out for testing
